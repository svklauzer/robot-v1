...
_KNOWN_UNGROUPED: frozenset[str] = frozenset({
    "ADAPTIVE_TRAIL_DRAWDOWN_PCT", "ALLOW_MARKET_MOCK",
    ...
    "EGRESS_DNS_TIMEOUT_SEC", "EGRESS_GUARD_ENABLED",
    ...
    "ENTRY_ZONE_TTL_SEC", "ENTRY_ZONE_WIDTH_PCT",
    ...
    "MIN_NET_PNL_TP1_USDT", "MIN_NET_PNL_TP2_USDT",
    ...
    "WALKFORWARD_ENABLED", "WALKFORWARD_FOLDS",
