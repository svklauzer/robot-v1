...
class Settings(BaseSettings):
    ...
    # ВСЕ — по разделу 3.1 ТЗ. Прежнее «di,obv» было моей осторожностью, а не
    # требованием: замер показал, что trend_up и trend_down дают 96% убытка
    # системы, и половинчатый фильтр этого не меняет.
