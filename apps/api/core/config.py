...
class Settings(BaseSettings):
    ...
    TRADEABLE_REGIMES: str = "reversal_long_candidate,crt,scalp"
    ...
    #
    # True = новые корзины не открываются, открытые доводятся до TP/стопа.
    ...
    #
    # Движок не сломан, он экономически несостоятелен на текущих издержках и
    # горизонтах. Вернуть имеет смысл при мейкерском исполнении обеих ног.
