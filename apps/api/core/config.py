...
class Settings(BaseSettings):
    ...
    # эквити против MAX_DAILY_LOSS_PCT=5. Совпадает с ANTI_DRAIN_MAX_OPEN_POSITIONS.
    # Впритык: пять одновременных стопов выбирают дневной лимит целиком.
    ...
    # (#risk-one-percent-2026-09-20) Поднят 2 → 5, вровень с MAX_DAILY_LOSS_PCT.
    ...
    ANTI_DRAIN_MAX_DAILY_LOSS_PCT: float = 5.0
    ...
    # RISK MANAGEMENT
    # =========================
    # (#risk-one-percent-2026-09-20) Поднят 3 → 5 вместе с риском на сделку.
    ...
    # отработать. 5% дают пять. Поднимать риск, не трогая лимит, бессмысленно.
