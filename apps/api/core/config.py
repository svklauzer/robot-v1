...
class Settings(BaseSettings):
    ...
    # По умолчанию только kama — единственное условие, которое говорит «тренда
    # больше нет», а не «тренд слабеет». Остальные включаются, когда наберётся
    # выборка: закрывать по ослаблению — это выбор между «взять меньше» и
    # «отдать больше», и он требует замера, а не мнения.
    TZ_EXIT_CONDITIONS: str = "kama,adx,obv"
