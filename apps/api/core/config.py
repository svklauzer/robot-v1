...
class Settings(BaseSettings):
    ...
    TZ_STOCH_ZONE: float = 20.0  # Лонг: %K <= 20 (дно отката); Шорт: %K >= 80 (пик отскока)
    ...
    ENTRY_ZONE_MAX_DRIFT_PCT: float = 0.35
    ...
    ENTRY_IMPULSE_WINDOW_SEC: float = 300.0 # три бара 5m
    ...
    MIN_NET_PNL_TP2_USDT: float = 3.50 # 29.08.2026 ,было 3.5
