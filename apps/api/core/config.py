...
class Settings(BaseSettings):
    ...
    # (#symbol-gate-inverted-2026-09-20) 20 → 10. Двадцати сделок на символ
    # не набирается даже за неделю (максимум 14), поэтому ветка ограничения
    # не срабатывала НИ РАЗУ — blocked всегда ноль.
    SYMBOL_PERF_BLOCK_MIN_HISTORY: int = 10
