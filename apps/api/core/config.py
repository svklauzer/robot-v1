...
class Settings(BaseSettings):
    ...
    # NEUTRAL (боковик/перегрев) → замораживаем добор НОВЫХ уровней (выходы TP/SL
    # продолжают работать). Размораживаем, когда регайм вернулся к стороне цикла.
    GRID_FREEZE_ON_NEUTRAL: bool = True
