...
class Settings(BaseSettings):
    ...
    ENTRY_ZONE_MAX_DRIFT_PCT: float = 0.35 # 25.09.2026 0.60 --> 0.35, импульс толкает цену вверх мы остаемся с expired сигналом при 0.60
    ...
    MIN_NET_RR_BLENDED: float = 0.85 # 25.09.2026 1.10 --> 0.85
