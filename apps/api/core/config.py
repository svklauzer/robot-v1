...
class Settings(BaseSettings):
    ...
    TZ_ENFORCE_MIN_SAMPLE: int = 40
    # Какие семейства условий блокируют вход: adx, di, stoch, obv.
    # По умолчанию только те, у которых НЕТ назначенного порога: di сравнивает
    # +DI с −DI, obv — OBV со своей EMA20. Их можно включать, не дожидаясь
    # калибровки, потому что калибровать в них нечего. adx и stoch держим в
    # тени до набора выборки.
    TZ_ENFORCE_CONDITIONS: str = "di,obv"
