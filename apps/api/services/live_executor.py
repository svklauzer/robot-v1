...
Гарантии безопасности:
  ...
  • предохранитель размера: нотионал ордера ограничен долей экспозиции
    (LIVE_MAX_ORDER_NOTIONAL_PCT; абсолютный ...USDT — аварийный запасной)
            ...
            if over_cap:
                log_event(logger, logging.WARNING, "live_order_notional_cap",
                          ...
                          note="в LIVE этот ордер был бы ОТКЛОНЁН кэпом. Поднять "
                               "LIVE_MAX_ORDER_NOTIONAL_PCT или снизить размер позиции "
