...
>
> **Боевые URL (Render присвоил суффиксы):**
> - API: `https://robot-api-fx9h.onrender.com`
> - Web: `https://robot-web-0xvm.onrender.com`
> - Telegram webhook: `https://robot-api-fx9h.onrender.com/telegram/webhook`
...
curl -H "X-Owner-Token: <OWNER_API_TOKEN>" \
  https://robot-api-fx9h.onrender.com/system/readiness
```
...
curl -X POST "https://api.telegram.org/bot<BOT_TOKEN>/setWebhook" \
  ...
  -d '{"url": "https://robot-api-fx9h.onrender.com/telegram/webhook"}'
...
```bash
curl -X POST https://robot-api-fx9h.onrender.com/system/kill-switch-smoke \
...
```bash
curl -H "X-Owner-Token: <OWNER_API_TOKEN>" \
  https://robot-api-fx9h.onrender.com/bot/state

curl -X POST https://robot-api-fx9h.onrender.com/system/product-e2e-smoke \
  -H "X-Owner-Token: <OWNER_API_TOKEN>" -H "Content-Type: application/json"
```
...
- URL: `GET https://robot-api-fx9h.onrender.com/health`
...
```bash
curl -X POST https://robot-api-fx9h.onrender.com/reports/send-owner \
...
После создания API Render присвоит URL вида `https://robot-api-fx9h.onrender.com` —
